...
version=${MSGVAULT_DOWNSTREAM_VERSION:-v0.19.3-discord-local.2}
image=${MSGVAULT_IMAGE:-ghcr.io/x1pher/msgvault:0.19.3-discord-local.2}

if [[ "$version" != "v0.19.3-discord-local.2" ]]; then
