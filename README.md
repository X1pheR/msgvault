# X1pheR-maintained msgvault downstream
...
docker run --rm ghcr.io/x1pher/msgvault:0.19.3-x1pher.3 import-discord-observations --help
```

The upstream installation documentation below remains the authority for upstream msgvault. Use the downstream image or build this repository when you need the maintained downstream delta.
...
msgvault export-messages \
  ...
  --message-type discord --source discord:123456789012345678
